...
fn colors_iter() {
    ...
    let mut it = g.colors(0);
    assert_eq!(it.len(), 0);
    assert_eq!(it.next(), None);
    assert_eq!(it.next_back(), None);

    let mut it = g.colors(1);
    cmp!(it.next(), "#000000");
    assert_eq!(it.next(), None);
    assert_eq!(it.next_back(), None);
    ...
    let mut it = g.colors(2);
    cmp!(it.next(), "#000000");
    cmp!(it.next(), "#ffffff");
    assert_eq!(it.next(), None);
    assert_eq!(it.next_back(), None);

    let mut it = g.colors(4);
    cmp!(it.next(), "#000000");
    cmp!(it.next(), "#ff0000");
    cmp!(it.next(), "#ffff00");
    cmp!(it.next(), "#ffffff");
